...
/* Descricao: implementa  o problema dos leitores/escritores em um vetor de inteiros sem nenhuma prioridade
*/
...
int prior = 0; // variável que define a prioridade entre leitores e escritores
