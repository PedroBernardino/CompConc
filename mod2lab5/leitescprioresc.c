...
/* Descricao: implementa  o problema dos leitores/escritores em um vetor de inteiros dando prioridade aos escritores
*/
...
int filaescr=0; //contador de escritores na fila para escrever
...
void InicLeit (int id) {
   ...
   printf("L[%d] quer ler (filaescr = %d)\n", id, filaescr);
   while((escr > 0) || (filaescr > 0)) {
     printf("L[%d] bloqueou\n", id);
